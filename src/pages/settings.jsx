...
//       setError(null);
//       const result = await axios.get("http://localhost:8080/api/departments/all");
//       setDepartments(Array.isArray(result.data) ? result.data : []);
//     } catch (error) {
//       setError("Unable to fetch departments: " + error.message);
//     } finally {
...
//       setEmployees(Array.isArray(result.data) ? result.data : []);
//     } catch (error) {
//       setError("Unable to fetch employees: " + error.message);
//     } finally {
...
//     try {
//       setError(null);
//       await axios.post("http://localhost:8080/api/departments/add", departmentForm);
//       fetchDepartments();
//       setDepartmentForm({ dep_name: "" });
//     } catch (error) {
...
//     try {
//       setError(null);
//       await axios.put(`http://localhost:8080/api/departments/update/${editDepartmentId}`, departmentForm);
//       fetchDepartments();
//       setDepartmentForm({ dep_name: "" });
//       setEditDepartmentId(null);
//     } catch (error) {
...
//         {/* Department Management */}
//         <div className="mb-8">
//           <h1 className="text-3xl font-bold mb-4 text-blue-600">Department Management</h1>
//           <div className="flex space-x-2 mb-4">
//             <input
//               type="text"
//               className="border rounded p-2 flex-grow"
//               value={departmentForm.dep_name}
//               onChange={(e) => setDepartmentForm({ ...departmentForm, dep_name: e.target.value })}
//               placeholder="Department Name"
//             />
//             <button
//               className="bg-blue-500 text-white px-4 py-2 rounded"
...
//         {/* Employee Management */}
//         <div className="mb-8">
//           <h1 className="text-3xl font-bold mb-4 text-green-600">Employee Management</h1>
//           <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
//             <input
//               type="text"
//               className="border rounded p-2"
//               value={employeeForm.emp_name}
//               onChange={(e) => setEmployeeForm({ ...employeeForm, emp_name: e.target.value })}
//               placeholder="Employee Name"
//             />
//             <input
//               type="text"
...
//               className="border rounded p-2"
//               value={employeeForm.dep_id}
//               onChange={(e) => setEmployeeForm({ ...employeeForm, dep_id: e.target.value })}
//             >
//               <option value="">Select Department</option>
//               {departments.map((dep) => (
//                 <option key={dep.dep_id} value={dep.dep_id}>
